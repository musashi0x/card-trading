...
Timed English auction capability for the card marketplace, enabling sellers to create auctions, buyers to place USDC-escrowed bids, and anyone to permissionlessly settle after the auction ends.
## Requirements
